 ...
 */
public class NewImageWizardPage extends NewTypeWizardPage {
	...
	public NewImageWizardPage() {
		...
		setDescription("Adding an image and updateing the existing code!");
	...
	private void generateOnCreate(IType type, ImportsManager imports) throws CoreException, JavaModelException {
		...
		buf.append("* @see android.app.Base Game Activity#onCreate(android.os.Bundle)")
				.append(lineDelim);
	...
	private void createIntentCategoriesControl(final Composite composite, int nColumns, Set<String> categories) {
		...
		ElementListSelector selector = new ElementListSelector(composite, gridData, "Intent categories", "Select Intent categories", categories.toArray(), 1);
	...
	private void createIntentActionsControl(final Composite composite, int nColumns, Set<String> actions) {
		GridData gridData = new GridData(SWT.FILL, SWT.TOP, true, false, nColumns, 1);
		ElementListSelector selector = new ElementListSelector(composite, gridData, "Intent actions", "Select Intent actions", actions.toArray(), 2);
