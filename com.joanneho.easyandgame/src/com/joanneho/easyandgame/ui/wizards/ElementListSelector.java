...
/**
 * Provides a List element with Add and Remove buttons to select entries from a list of Objects.
...
public class ElementListSelector {
	...
	public ElementListSelector(final Composite composite, GridData gridData, final String groupDescr, final String selectionMessage, final Object[] elements, int typeOfList) {
		this.elements = elements;
		Group intentGroup = new Group(composite, SWT.NONE);
		
		//intentGroup.setData("android.intent.action.MAIN", "android.intent.action.MAIN");
		...
		list.setLayoutData(new GridData(SWT.FILL, SWT.TOP, true, false));
		if (typeOfList ==1)
			list.add("android.intent.category.LAUNCHER");
		else if (typeOfList == 2)
			list.add("android.intent.action.MAIN");
		//list.add("android.intent.category.LAUNCHER");
		//selectedElements.add("android.intent.action.MAIN");
